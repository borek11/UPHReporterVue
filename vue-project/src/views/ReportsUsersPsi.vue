<template>
    <div class="container-fluid">
        <div class="text-white text-center mt-2 mb-4 h2">
            Raporty użytkowników: Page Speed Insights
                ...
                <div class="shadow p-3 mb-5 rounded">
                    ...
                    <div class="row m-auto mt-4">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row ">
                                <div class="col-5 text-end fw-bold">Poprawne elementy</div>
                                <div class="col-2">:</div>
        ...
        methods: {
            ...
            async getMultiReport(domain){
                try {
                    ...
                    let response = await axios.get(this.$store.state.connectionString + 'PageSpeed/getByUser?id=' + domain.id, {headers: {Authorization: 'Bearer ' + localStorage.getItem('token')}});
